...
$contentColumns['tx_ewgallery_video']['config']['allowed_types'] = 'flv,f4v,mp4,mov';
$contentColumns['tx_ewgallery_video']['config']['disallowed_types'] = '';
$contentColumns['tx_ewgallery_video']['config']['maxitems'] = 1;
$contentColumns['tx_ewgallery_video']['config']['size'] = 1;
