	...
	************************************************************************************************************/	
//alert('ich werde ausgeführt: xp-info-pane.js')
	/* Update LOG 
	...
	function initDhtmlgoodies_xpPane(panelTitles,panelDisplayed,cookieArray)
	{
		...
		for(var no=0;no<divs.length;no++){
			if(divs[no].className=='dhtmlgoodies_panel'){
				...
				img.src = '../typo3conf/ext/go_imageedit_be/res/image-crop/images/arrow_up.gif';				
				...
				if(!panelDisplayed[dhtmlgoodies_paneIndex]){
					...
					img.src = '../typo3conf/ext/go_imageedit_be/res/image-crop/images/arrow_down.gif';
				}
