...
$TYPO3_CONF_VARS['EXT']['extList'] = 'css_styled_content,version,tsconfig_help,context_help,extra_page_cm_options,impexp,sys_note,tstemplate,tstemplate_ceditor,tstemplate_info,tstemplate_objbrowser,tstemplate_analyzer,func_wizards,wizard_crpages,wizard_sortpages,lowlevel,install,belog,beuser,aboutmodules,setup,taskcenter,info_pagetsconfig,viewpage,rtehtmlarea,t3skin,t3editor,reports,templavoila,media_center,kickstarter,ew_tsconfig,dam,ew_gallery,dam_index,ew_pibase,static_info_tables,ew_facts,ew_press,recycler,formhandler,ew_calendar,rb_flashobject,realurl,realurlmanagement,aeurltool,ew_content,info,perm,func,filelist,about,cshmanual,ew_language';	// Modified or inserted by TYPO3 Extension Manager. Modified or inserted by TYPO3 Core Update Manager. 
$TYPO3_CONF_VARS['EXT']['extList_FE'] = 'css_styled_content,version,install,rtehtmlarea,t3skin,templavoila,media_center,kickstarter,ew_tsconfig,dam,ew_gallery,dam_index,ew_pibase,static_info_tables,ew_facts,ew_press,formhandler,ew_calendar,rb_flashobject,realurl,realurlmanagement,aeurltool,ew_content,ew_language';	// Modified or inserted by TYPO3 Extension Manager. 
